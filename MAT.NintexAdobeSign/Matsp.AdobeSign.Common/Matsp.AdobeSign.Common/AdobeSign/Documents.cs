    ...
    public class DocumentCreationInfo
    {
      ...
      //  [DataMember(EmitDefaultValue = false)]
       // public string signatureFlow { get; set; }
        ...
        [DataMember(Name = "signatureFlow")]
        public string signatureFlowtring
        {
            get { return signatureFlow.ToString(); }
            set
            {
                SignatureFlow g;
                this.signatureFlow = Enum.TryParse(value, true, out g) ? g : SignatureFlow.SENDER_SIGNATURE_NOT_REQUIRED;
            }
        }
