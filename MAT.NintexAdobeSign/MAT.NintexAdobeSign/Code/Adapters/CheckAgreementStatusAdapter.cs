...
namespace Akki.NintexAdobeSign
{
    ...
    /// </summary>
    public class CheckAgreementStatusAdapter : GenericRenderingAction
{
                /// <summary>
        ...
        public override bool ValidateConfig(ActivityContext context)
        {
            ...
            var prop = parameters[CheckAgreementStatusActivity.KeyAgreementID];
            if (string.IsNullOrEmpty(prop.Value))
            {
                validationSummary.AddError(CheckAgreementStatusActivity.KeyAgreementID, ValidationSummaryErrorType.CannotBeBlank);
                isValid &= false;
            }
            return isValid;
        }
        ...
        public override ActionSummary BuildSummary(ActivityContext context)
        {
            ...
            displayMessage = string.Format("Checks the ESign Status of Agreement in Adobe System");
