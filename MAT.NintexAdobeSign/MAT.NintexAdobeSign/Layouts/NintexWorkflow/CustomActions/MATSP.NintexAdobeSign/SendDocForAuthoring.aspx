...
<%@ Page Language="C#" DynamicMasterPageFile="~masterurl/default.master" AutoEventWireup="true" CodeBehind="SendDocForAuthoring.aspx.cs" EnableEventValidation="false"
...
<asp:Content ID="ContentHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function TPARetrieveConfig()
        {
            ...
            setRTEValue('<%=AgreementName.ClientID%>', configXml.selectSingleNode("/NWActionConfig/Parameters/Parameter[@Name='AgreementName']/PrimitiveValue/@Value").text); 
            ...
            setRTEValue('<%=CompendiumDocsID.ClientID%>', configXml.selectSingleNode("/NWActionConfig/Parameters/Parameter[@Name='CompendiumDocsID']/PrimitiveValue/@Value").text);
            ...
            var drpUrl = document.getElementById("<%= OutAuthoringUrl.ClientID %>");
            drpUrl.value = configXml.selectSingleNode("/NWActionConfig/Parameters/Parameter[@Name='OutAuthoringUrl']/Variable/@Name").text;
        ...
        function TPAWriteConfig()
        {
            ...
            configXml.selectSingleNode("/NWActionConfig/Parameters/Parameter[@Name='AgreementName']/PrimitiveValue/@Value").text = getRTEValue('<%=AgreementName.ClientID%>'); 
            ...
            configXml.selectSingleNode("/NWActionConfig/Parameters/Parameter[@Name='CompendiumDocsID']/PrimitiveValue/@Value").text = getRTEValue('<%=CompendiumDocsID.ClientID%>');  
            ...
            var drpUrl = document.getElementById("<%= OutAuthoringUrl.ClientID %>");
            configXml.selectSingleNode("/NWActionConfig/Parameters/Parameter[@Name='OutAuthoringUrl']/Variable/@Name").text = drpUrl.value; 
	        return true;
        }
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="PlaceHolderMain" runat="Server">     
    <Nintex:ConfigurationPropertySection runat="server" Id="MainControls1">
        <TemplateRowsArea>
           ...
           <Nintex:ConfigurationProperty runat="server" FieldTitle="Agreement Name" >
                   <TemplateControlArea>                       
                        <Nintex:SingleLineInput clearFieldOnInsert="true"  runat="server" id="AgreementName"></Nintex:SingleLineInput>
                  </TemplateControlArea>
           </Nintex:ConfigurationProperty>
           ...
           <Nintex:ConfigurationProperty runat="server" FieldTitle="Comma separated list of doc Ids to be added to the main doc">
                   <TemplateControlArea>                       
                        <Nintex:SingleLineInput clearFieldOnInsert="true"  runat="server" id="CompendiumDocsID"></Nintex:SingleLineInput>
                  </TemplateControlArea>
           </Nintex:ConfigurationProperty> 
           ...
           <Nintex:ConfigurationProperty runat="server" FieldTitle="Adobe Agreement Id" RequiredField="True">
            ...
            <Nintex:ConfigurationProperty runat="server" FieldTitle="Adobe Authoring Url" RequiredField="True">
                <TemplateControlArea>
                     <Nintex:VariableSelector ID="OutAuthoringUrl" runat="server" IncludeTextVars="True"></Nintex:VariableSelector>
                </TemplateControlArea>
           </Nintex:ConfigurationProperty>           
